...
def home():
    ...
    message = tk.Label(login_frm, text="By Shivam" ,bg="white"  ,fg="black"  ,width=15 ,height=2,font=('Times New Roman', 25, 'bold')) 
    message.place(relx=0.75, rely=0.75)
    ...
    quitWindow.place(x=650, y=650-y_marg)
